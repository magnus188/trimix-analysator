...
def _state(design):
    ...
    top_level = {o.fullPathName for o in root.occurrences}
    state['occurrence_bindings'] = {o.fullPathName:dict(component_id=o.component.id,
        ...
        # Fusion permits global isGrounded only for top-level occurrences.
        # Nested grounding is represented by the actual isGroundToParent above.
        grounded=bool((o.nativeObject or o).isGrounded) if o.fullPathName in top_level else None,
        global_grounding_applicability='top_level' if o.fullPathName in top_level else 'not_applicable_to_subcomponent_use_grounded_to_parent',
        attributes=attrs(o.nativeObject or o)) for o in root.allOccurrences}
