...
def localize_mate():
    import connector_cable_checks as checks
    importlib.reload(checks)
    checks.mate_localization()


def check_wet_front():
    import connector_cable_checks as checks
    importlib.reload(checks)
    checks.wet_front_routes()


def refine_wet_front():
    import connector_cable_checks as checks
    importlib.reload(checks)
    checks.wet_front_routes_refined()


def trial_carrier_sidebridge():
    import connector_cable_checks as checks
    importlib.reload(checks)
    checks.carrier_sidebridge_trial()


def trial_hardware_offset():
    import connector_cable_checks as checks
    importlib.reload(checks)
    checks.hardware_offset_trial()


def trial_larger_wires():
    import connector_cable_checks as checks
    importlib.reload(checks)
    checks.larger_wire_trial()


def trial_shaped_wires():
    import connector_cable_checks as checks
    importlib.reload(checks)
    checks.shaped_wire_trial()


def check_intended_mates():
    import connector_cable_checks as checks
    importlib.reload(checks)
    checks.intended_mates()


def save_interface_checkpoint():
    import connector_final_checkpoint as checkpoint
    importlib.reload(checkpoint)
    checkpoint.save()


def reopen_interface_checkpoint():
    import connector_final_checkpoint as checkpoint
    importlib.reload(checkpoint)
    checkpoint.reopen()
