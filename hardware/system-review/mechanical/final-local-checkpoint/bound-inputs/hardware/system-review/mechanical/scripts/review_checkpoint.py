...
def _state(design):
    ...
    descendants = {o.fullPathName: {'local_pose': list((o.nativeObject or o).transform2.asArray()),
    ...
    return {'bodies': audit._bodies(design), 'poses': {k:list(v)for k,v in step._poses(design).items()},
