...
def photo_model():
    ...
    c=_new(b,'Guition / PCB and core photo reference','Manufacturer65.06x108outline; PCBthickness1.6 andfrontstackareunmeasuredreferences. Alloldillustrationsremoved.')
    ...
    # Real-board long mounting-hole spacing102.6; externalcaseears108 are registration datums, not thesePCBholes.
