...
def main():
    ...
    box(642,137,162,92,'Guition screen','J301 to JP1; power entry on hold.<br/>HOST_3V3 from screen.<br/>Onboard SD; GPIO52 unused.')
    ...
    para('Owner photo: header and both USB sockets are at the top; SD slot at the left. Complete cable bends, card ejection and mated heights remain under review. Sources: integration-photo/README.md, mechanical/MEASUREMENTS.md and electrical/measurement-and-bringup.md.',36,486,740,'small')
    ...
    for half,x in [(data[:13],36),(data[13:],429)]:
        table(['Pin','Net','GPIO','Direction'],half,x=x,y=137,widths=[30,157,38,112],rowheight=23)
    line('Current J301 cable exit: inward (-X). Guition end: unkeyed, with pin 7 cavity open. Full loom fit remains pending.',36,476,8.5,BLUE)
    ...
    measure=[
        ...
        ('Guition USB / SD','Top USB plug clearance; left SD eject travel and grip; display-release access.'),
    ...
    table(['Item','Needed evidence'],measure,widths=[135,605],rowheight=34)
    para('<b>Recorded already:</b> display 69.3 x 116.8 x 13.7 mm; front glass to bare header tips 13.4 mm; occupied protected holder 42 x 80.4 x 20.35 mm. The owner confirms a common oxygen thread, with JJ-CCR 2 mm smaller in diameter and 2 mm longer. Mated heights, sealing faces and the extra-length datum still need verification.',36,492,740,'small')
    ...
    para('Confirmed: microscope, soldering/hot-air stations, DL24/P load, DLA 24 MHz logic analyser, FNB58 USB tester, multimeter, oscilloscope and DC PSU. Verify instrument limits, PSU current limiting and probe grounding. A nonsinking PSU is not a battery emulator. See lab-equipment.md; every physical test remains pending.',36,463)
    ...
    c.save()
    sources=[PINMAP,HOST,HERE/'mechanical/MEASUREMENTS.md',HERE/'first-power.md',HERE/'lab-equipment.md',HERE/'integration-photo/README.md',HERE/'integration-photo/registration.json',HERE/'integration-photo/current-host-pose.json',HERE/'electrical/measurement-and-bringup.md',HERE/'electrical/host-harness-review/contract.json',HERE/'electrical/host-power-review/sources.json',HERE/'electrical/co-module-use-review.md',Path(__file__)]
