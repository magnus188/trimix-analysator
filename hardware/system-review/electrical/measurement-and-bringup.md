...
The owner now confirms the microscope, soldering/hot-air equipment, DL24/P, DLA 24 MHz logic analyser, FNB58 USB tester, multimeter, oscilloscope and DC PSU. See [instrument roles and setup limits](../lab-equipment.md). Instrument specifications and test fixtures still need qualification.
