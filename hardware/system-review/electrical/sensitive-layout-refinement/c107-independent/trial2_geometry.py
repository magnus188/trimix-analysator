...
f.SetPosition(v((13.75,78.75)));f.SetOrientationDegrees(0)
...
def via_hits(a,net='GND',dia=.6):
 ...
 return hits
G=(15.225,78.75);REG=(12.275,78.75)
result={'pose':[13.75,78.75,0],'pack_paths':[],'gnd_to_existing':[],'vias':[],'regn':blocked(REG,(12.79,81.15),'/01  CHARGING + BATTERY/BQ_REGN',.25)}
for points in [[(10.64,79.9091),(11.1,79.95),(11.1,77.4),(14.15,77.4),(16.1271,74.422)],[(10.64,79.9091),(10.6,77.4),(13.4,77.4),(16.1271,74.422)],[(10.64,79.9091),(10.65,79.95),(13.25,79.95),(13.65,77.25),(16.1271,74.422)],[(10.64,79.9091),(10.8,80),(13.2,80),(13.2,77.0),(16.1271,74.422)]]:
...
(D/'trial2-geometry.json').write_text(json.dumps(result,indent=2)+'\n');print(json.dumps(result,indent=2))
