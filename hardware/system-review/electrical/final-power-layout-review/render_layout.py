...
out=Path(__file__).resolve().parent;src=Path('hardware/pcb/analyzer/Trimix_Analyzer.kicad_pcb');data=src.read_bytes();n=Native(sexpdata.loads(data.decode()))
assert hashlib.sha256(data).hexdigest()=='9f274fdf198f1bcb871a4fc360e76693f8a5b048553e6a02998141737956514f'
