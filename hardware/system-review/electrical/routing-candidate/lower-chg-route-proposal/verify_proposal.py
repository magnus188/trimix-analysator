...
assert sha(before)=='25ccd798740da0ac1c45eccec28d6cfc83d5a4f81b867c085142661a17155ada'
...
allowed={'CHG_INT_N'}
assert len(removed)==2 and all(child(old[k],'net')[1]=='CHG_INT_N' for k in removed)
assert len(added)==17 and all(child(new[k],'net')[1]=='CHG_INT_N' for k in added)
