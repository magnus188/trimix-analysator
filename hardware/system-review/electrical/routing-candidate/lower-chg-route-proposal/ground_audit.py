...
files=['before.kicad_pcb','Trimix_Analyzer.kicad_pcb'];area=box(7,-99.2,28.5,-81)
...
def draw(g,c):
 ...
 return s
s=['<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 90 42" width="2520" height="1176"><rect width="90" height="42" fill="white"/>']
for k,n in enumerate(natives):
 for j,L in enumerate(['F.Cu','B.Cu','In1.Cu','In2.Cu']):
  s.append(f'<g transform="translate({j*22.5-7},{k*21-80})">')
  for z in n.zones:
