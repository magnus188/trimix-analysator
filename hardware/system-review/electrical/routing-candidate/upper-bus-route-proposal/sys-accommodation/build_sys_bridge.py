...
EXPECTED='01b013196d3db09db2d506edf1cd52908d13c4d3dbc7730eeb2da5f7b51655ec'
...
virtual=[]
def reserve(points,layer,width=.15,net="HOST_3V3"):
 for a,z in zip(points,points[1:]):
  t=p.PCB_TRACK(b);t.SetStart(vec(a));t.SetEnd(vec(z));t.SetWidth(p.FromMM(width));t.SetNetCode(NETS[net]);t.SetLayer(layer);b.Add(t);virtual.append(t)
...
reserve([(15.84,84.25),(17.5,83.9),(19,83.3)],p.In2_Cu,width=.40,net='VSYS')
