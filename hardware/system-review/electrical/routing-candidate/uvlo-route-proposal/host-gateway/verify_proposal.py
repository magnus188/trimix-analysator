...
assert sha(before)=='14284b78370caaffa001b68c1985423ae700f3e24f02e64b3e80fd50b43b93b1'
...
allowed={'HOST_3V3'}
assert len(removed)==1 and all(child(old[k],'net')[1]=='HOST_3V3' for k in removed)
assert len(added)==3 and all(child(new[k],'net')[1]=='HOST_3V3' for k in added)
