...
import build_gauge as c
p=c.p; b=c.b
def route(NET,start,end,end_layers=(0,1,2),start_layers=(0,),width=.15,allow_vias=True,bounds=(6.0,68.0,20.5,79.0)):
...
route('USB_5V',(16.3692,71.9863),(17.4989,73.116),end_layers=(2,),start_layers=(2,),width=.4,allow_vias=False,bounds=(14.8,71.8,18.5,73.8))
route('GAUGE_ALERT_N',(17.19,72.035),(11.95,71.65),start_layers=(0,1,2))
c.save()
