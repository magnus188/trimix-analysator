...
EXPECTED='3a80cb5790642217c881de08bef14d233bbb3f8f6b44477a32f7e113180b04f3'
...
assert xy(f.GetPosition())==[3.9,83.55]
old=xy(f.GetPosition());oldrot=f.GetOrientationDegrees()
f.SetPosition(vec((3.4,83.5)));f.SetOrientationDegrees(0)
poses.append({'reference':'R107','before':old,'before_rotation_deg':oldrot,'after':[3.4,83.5],'rotation_deg':0})
