...
assert sha(before)=='12fc60412aa21dcbca3f4fb69da038a8d312193734992441231de17a70e3d5bc'
...
assert len(added)==21 and all(child(new[k],'net')[1] in allowed for k in added)
