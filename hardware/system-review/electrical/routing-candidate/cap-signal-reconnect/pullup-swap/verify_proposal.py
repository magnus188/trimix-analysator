...
assert sha(before)=='43046290dd43fb281ee8711e50924bf6cb4f689afc3f26330c916a1776d2a0c3'
...
assert {ref(fpo[k]) for k in fpc}=={'R107','R302'}, 'Only R107/R302 pose changes authorized'
for k in fpc:
 q1,q2=fpo[k],fpn[k]
...
allowed={'CHG_INT_N','HOST_3V3','I2C_SCL'}
assert len(removed)==22
assert len(added)==19 and all(child(new[k],'net')[1] in allowed for k in added)
