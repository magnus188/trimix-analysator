...
assert sha(before)=='3a80cb5790642217c881de08bef14d233bbb3f8f6b44477a32f7e113180b04f3'
...
assert {ref(fpo[k]) for k in fpc}=={'R107'}, 'Only R107 pose change authorized'
for k in fpc:
 q1,q2=fpo[k],fpn[k]
...
allowed={'CHG_INT_N','HOST_3V3'}
assert len(removed)==0
assert len(added)==17 and all(child(new[k],'net')[1] in allowed for k in added)
