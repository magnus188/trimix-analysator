...
held={'Net-(L201-Pad1)','Net-(L201-Pad2)','CO_SW','/01  CHARGING + BATTERY/BQ_SW','/01  CHARGING + BATTERY/BQ_PMID'}
check('switch and PMID loops remain on front copper',all(t.GetLayer()==p.F_Cu for t in tracks if t.GetNetname()in held),sorted(held))
