...
out=D/'candidate3';out.mkdir(exist_ok=True)
...
removed=[];added=[];mutated=[];dead={'54b7bc9f-e4cd-4b0b-9003-590e0153dba7','60490e6d-9dc3-40db-b8c2-c06eed5eef94','075fcbfb-49ac-4a0d-8a19-3383e3944e12','ae911bf7-cc2f-41a5-a7c8-2c765e0d5a56','2b8c2651-e963-4c7b-a23c-346fba30a357','646b0393-4d73-4cbb-928d-8dec9de95cea','d1405bfb-6338-4612-8398-1b85906c2ea9'}
keeprefs=[]
for t in list(b.GetTracks()):
 ...
 if u=='4d3d290c-99a4-46a5-942a-40540e1a2ad8':
  t.SetEnd(vec((20.0894,47.75)));mutated.append(dict(uuid=u,end=[20.0894,47.75]))
...
(out/'fp-lib-table').write_text((src.parent/'fp-lib-table').read_text().replace('${KIPRJMOD}',str(src.parent)))
