...
out=D/'candidate';out.mkdir(exist_ok=True)
...
removed=[];added=[];mutated=[];dead={'54b7bc9f-e4cd-4b0b-9003-590e0153dba7','60490e6d-9dc3-40db-b8c2-c06eed5eef94','075fcbfb-49ac-4a0d-8a19-3383e3944e12','ae911bf7-cc2f-41a5-a7c8-2c765e0d5a56','2b8c2651-e963-4c7b-a23c-346fba30a357'}
keeprefs=[]
for t in list(b.GetTracks()):
 u=t.m_Uuid.AsString()
 if u in dead:removed.append(u);keeprefs.append(t);b.Remove(t)
 if u=='918a51d0-58a7-44e8-a4f9-89dfe314382a':
  t.SetPosition(vec((16.5,48.3532)));mutated.append(dict(uuid=u,at=[16.5,48.3532]))
...
route('HE_EXC_DIV',p.F_Cu,[(16.5,48.3532),(16.8532,48),(19.075,48)])
# The old B trunk physically intersects R504.2 and the relocated via; no label-based join.
