...
import pcbnew as p
D=Path(__file__).resolve().parent;OUT=D/'co-repack3';OUT.mkdir(exist_ok=True)
...
f=fps['C702'];f.SetPosition(vec((21.5,54.2)));f.SetOrientationDegrees(0)
...
track('CO_SW',[(20.2125,56.3),(21.5,56.3),(21.5,53.15),new['2']],p.F_Cu,.2)
track('CO_5V28',[(20.55,54.2),(20.2125,54.9296)],p.F_Cu,.25)
track('GND',[(22.45,54.2),(23.35,54.25)],p.F_Cu,.35)
