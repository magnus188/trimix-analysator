...
import pcbnew as p
D=Path(__file__).resolve().parent;OUT=D/'c103-local';shutil.copytree(D/'baseline',OUT,dirs_exist_ok=True)
...
via(nets['1'],(15.55,80.95));track(nets['1'],[(15.08,80.7),(15.55,80.95)],p.B_Cu,.2)
track(nets['1'],[(14.25,80.1),(15.55,80.1),(15.55,80.95)],p.F_Cu,.2)
