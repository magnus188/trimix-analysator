...
p=c.p
helper=c.D.parents[1]/'upper-bus-route-proposal/island_targets.py';spec=importlib.util.spec_from_file_location('native_islands',helper);mod=importlib.util.module_from_spec(spec);spec.loader.exec_module(mod)
