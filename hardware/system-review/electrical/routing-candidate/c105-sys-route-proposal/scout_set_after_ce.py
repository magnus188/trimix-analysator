...
c.P=c.OUT/'ce-bridge-scout/candidate/Trimix_Analyzer.kicad_pcb'
c.EXPECTED='3ba04d481d49b39d87a800c941448d665bcbd465af761bb2b0d617c23429b469'
assert hashlib.sha256(c.P.read_bytes()).hexdigest()==c.EXPECTED
c.b=c.p.LoadBoard(str(c.P))
c.OUT=c.OUT/'set-after-ce-scout';c.OUT.mkdir(exist_ok=True)
...
NET='USB_OVP_SET';bounds=(.8,79,29.15,94.3)
