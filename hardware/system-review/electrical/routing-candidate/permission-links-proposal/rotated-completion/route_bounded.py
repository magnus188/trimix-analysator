...
def route(NET,start,end,end_layers=(0,1,2),start_layers=(0,),width=.15,allow_vias=True,bounds=(.6,86.8,11.5,96.2)):
 ...
 reservations=[]
 for at in [(13,91.65),(7.1,90.35),(10,90)]:
 ...
 for L,points,w in [(p.F_Cu,[(6.15,90.5),(7.1,90.35)],.4),(p.F_Cu,[(8.85,90.5),(8.85,91.45),(8.85,92.2)],.4),(p.F_Cu,[(8.85,89.55),(9.2,89.55),(10,90)],.25)]:
