...
for side in ['F']:
 ...
 for ang in [0,90,180,270]:
  for xi in range(420,561):
   for yi in range(1560,1780):
    at=(xi/20,yi/20)
...
results.sort(key=lambda q:q['score']);(D/'r118-front-scout.json').write_text(json.dumps(results,indent=2));print('total',len(results));print(json.dumps(results[:30],indent=2))
