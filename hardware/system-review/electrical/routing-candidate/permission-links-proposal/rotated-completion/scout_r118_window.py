...
for side in ['B']:
 ...
 for ang in [0,90,180,270]:
  for xi in range(480,501):
   for yi in range(1640,1681):
    at=(xi/20,yi/20)
...
results.sort(key=lambda q:q['score']);(D/'r118-cad-window-scout.json').write_text(json.dumps(results,indent=2));print('total',len(results));print(json.dumps(results[:30],indent=2))
