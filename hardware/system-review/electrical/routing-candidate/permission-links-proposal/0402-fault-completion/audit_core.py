...
source=sexpdata.loads((D/'before.kicad_pcb').read_text());target=sexpdata.loads((D/'q110-core-frozen.kicad_pcb').read_text());a,b=Native(source),Native(target)
