...
p=c.p;c.b=p.LoadBoard(str(D/'no-new-clr-base.kicad_pcb'));b=c.b
for ref,at,ang,side in [('R116',(5.35,88.7),180,'B'),('R119',(5.5,88.5),180,'F'),('R118',(10.75,91.95),180,'F')]:
...
c.save();(D/'five-results.json').write_text(json.dumps(results,indent=2)+'\n')
