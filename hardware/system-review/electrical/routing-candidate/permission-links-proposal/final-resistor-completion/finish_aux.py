...
for f in b.GetFootprints():
 if f.GetReference()=='R116':f.SetOrientationDegrees(0);f.SetPosition(c.vec((7.75,94.75)))
 if f.GetReference()=='R118':f.SetOrientationDegrees(180);f.SetPosition(c.vec((10.75,91.95)))
 if f.GetReference()=='R119':f.Flip(f.GetPosition(),False);f.SetOrientationDegrees(0);f.SetPosition(c.vec((5.15,88.15)))
