...
import cairosvg
D=Path(__file__).resolve().parent;n=Native(sexpdata.loads((D/'q-pulldown-stage.kicad_pcb').read_text()))
...
for L in ['F.Cu','In2.Cu','B.Cu']:
 a=['<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="1000" viewBox="2 -96 17 14"><rect x="2" y="-96" width="17" height="14" fill="#151820"/>']
