...
c.b=c.p.LoadBoard(str(c.D/'stage-clr-pruned.kicad_pcb'))
...
jobs=[('SERIES','USB_ILIM_SERIES',at('Q110',2),at('Q111',3),(0,),(0,)),('Qgate','USB_PERMISSION_Q',at('Q110',1),(16.1827,91.7017),(0,),(0,1,2)),('ILIM','USB_ILIM_BRANCH',at('R116',2),at('Q110',3),(0,),(0,)),('LIMIT','USB_LIMIT_SET',at('R116',1),(9.6602,92.2602),(0,),(0,)),('Qpull','USB_PERMISSION_Q',at('R118',1),(22.0427,87.1732),(2,),(0,1,2)),('GND','GND',at('R118',2),at('J102',2),(2,),(0,1,2)),('CLR','USB_PERMISSION_CLR_N',at('U113',1),(12.2546,95.1046),(0,),(0,1,2))]
order=['LIMIT','ILIM','Qpull','GND']
jobs=sorted([j for j in jobs if j[0] in order],key=lambda j:order.index(j[0]))
