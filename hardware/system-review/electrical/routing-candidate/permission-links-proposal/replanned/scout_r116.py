...
for side in ['F','B']:
 ...
 for ang in [0,90,180,270]:
  for xi in range(60,221):
   for yi in range(850,965):
    at=(xi/10,yi/10)
...
results.sort(key=lambda q:q['score']);(D/'r116-scout.json').write_text(json.dumps(results,indent=2));print('total',len(results));print(json.dumps(results[:30],indent=2))
