...
results.sort(key=lambda q:q['score']);(D/'r115-upper-scout.json').write_text(json.dumps(results,indent=2));print('total',len(results));print(json.dumps(results[:30],indent=2))
