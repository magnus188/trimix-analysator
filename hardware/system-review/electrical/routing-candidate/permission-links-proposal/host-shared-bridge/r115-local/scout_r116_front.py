...
for side in ['F']:
 ...
 for ang in [0,90,180,270]:
  for xi in range(60,231):
   for yi in range(1700,1850):
    at=(xi/20,yi/20)
    ...
    results.append(dict(side=side,at=at,angle=ang,score=math.dist(at,(5.5,88.5))))
results.sort(key=lambda q:q['score']);(D/'r116-front-scout.json').write_text(json.dumps(results,indent=2));print('total',len(results));print(json.dumps(results[:30],indent=2))
