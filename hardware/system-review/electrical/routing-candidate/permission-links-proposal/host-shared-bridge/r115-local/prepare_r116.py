...
lib=Path('/Applications/KiCad/KiCad.app/Contents/SharedSupport/footprints/Resistor_SMD.pretty/R_0402_1005Metric.kicad_mod');new=s.loads(lib.read_text());raw=s.loads((D/'r115-coordinated-frozen.kicad_pcb').read_text())
...
(D/'r116-scout-base.kicad_pcb').write_text(s.dumps(raw)+'\n')
