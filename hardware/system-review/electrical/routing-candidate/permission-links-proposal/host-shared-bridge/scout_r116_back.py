...
for side in ['B']:
 ...
 for ang in [0,90,180,270]:
  for xi in range(50,181):
   for yi in range(1680,1830):
    at=(xi/20,yi/20)
...
results.sort(key=lambda q:q['score']);(D/'r116-back-edge-scout.json').write_text(json.dumps(results,indent=2));print('total',len(results));print(json.dumps(results[:30],indent=2))
