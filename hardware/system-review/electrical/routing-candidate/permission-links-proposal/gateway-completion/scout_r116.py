...
for side in ['F']:
 L=side+'.Cu';obs=[q for q in n.pads_on(L)if q['ref']not in ['R116','R119']]+[q for q in n.tracks if q['layer']==L]+n.vias
 ...
 othercy=[courtyard(f,side)for ref,f in fps.items()if ref not in ['R116','R119']];othercy=[q for q in othercy if not q.is_empty]
