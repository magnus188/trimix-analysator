...
assert sha(before)=='b819838cd4dcab44f12a37e3195da0d47c529e2027f6637c2f12360f1e433c74'
...
allowed={'HOST_3V3','CHG_INT_N'}
assert len(removed)==5 and all(child(old[k],'net')[1]=='CHG_INT_N' for k in removed)
assert len(added)==13 and all(child(new[k],'net')[1]=='HOST_3V3' for k in added)
