...
def main():
    ...
    previous['checkpoint'] = 'Verified charger input-isolation and charge-standby integration; production commissioning profile remains charge inhibited. Final hardware/CAD integration tracked separately.'
