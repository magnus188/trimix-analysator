...
def build():
 ...
 path=OUT/'Trimix_Analyzer_connector_swap_final_candidate.kicad_pcb';p.SaveBoard(str(path),b)
 ...
 (OUT/'candidate-final-checks.json').write_text(json.dumps(r,indent=2)+'\n');print(json.dumps(r,indent=2))
