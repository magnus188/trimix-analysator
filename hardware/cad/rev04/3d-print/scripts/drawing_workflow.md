...
These helpers prepare **actual Fusion Drawing documents and Animation storyboards**. The earlier `rev04/previews/exploded.png` and review PDF are visual reviews, not a native storyboard or associative drawing. None of the helpers execute when imported. Root must serialize every Fusion/UI operation with the geometry work.
