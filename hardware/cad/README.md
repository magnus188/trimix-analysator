# Trimix enclosure CAD

The latest enclosure source is [Revision 04](rev04/), with viewport images in
[`rev04/previews/`](rev04/previews/). The A3 printing package is kept with that
revision under [`rev04/3d-print/`](rev04/3d-print/). Open the prepared PLA or
PETG Bambu Studio projects from
[`rev04/3d-print/printing/bambu-studio/`](rev04/3d-print/printing/bambu-studio/).

The files in this directory below the overview are the earlier Revision 02
concept and remain available for design history.
...
- [View images](previews/): individual Fusion viewport exports. The rear-open view hides the outer cover and internal chamber lid; the centre section is at X = 0.
