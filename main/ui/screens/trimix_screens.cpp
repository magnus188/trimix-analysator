...
static lv_obj_t *create_home_screen(void){
    ...
    lv_obj_set_style_text_font(title, &custom_font_bold_24, 0);
    ...
    auto make_btn = [&](const char *txt, int col, int row, lv_event_cb_t cb){
        ...
        lv_obj_set_style_text_font(label, &custom_font_normal_20, 0);
        lv_obj_center(label);
        return btn;
    };
...
static lv_obj_t *create_dive_planner_screen(void){
    ...
    lv_obj_set_style_text_font(info, &custom_font_normal_20, 0);
...
static lv_obj_t *create_analyze_screen(void){ auto &mgr=M(); lv_obj_t *screen=lv_obj_create(NULL); lv_obj_set_style_bg_color(screen, COLOR_BACKGROUND,0); lv_obj_t *title=lv_label_create(screen); lv_label_set_text(title,"Real-time Analysis"); lv_obj_set_style_text_font(title,&custom_font_bold_24,0); lv_obj_set_style_text_color(title, lv_color_white(),0); lv_obj_align(title, LV_ALIGN_TOP_MID,0,10); lv_obj_t *grid_container=lv_obj_create(screen); lv_obj_set_size(grid_container, LV_PCT(90),600); lv_obj_align(grid_container, LV_ALIGN_CENTER,0,20); lv_obj_set_style_bg_opa(grid_container, LV_OPA_TRANSP,0); lv_obj_set_style_border_width(grid_container,0,0); lv_obj_set_layout(grid_container, LV_LAYOUT_GRID); static int32_t col_dsc[]={LV_GRID_FR(1), LV_GRID_FR(1), LV_GRID_TEMPLATE_LAST}; static int32_t row_dsc[]={LV_GRID_FR(1), LV_GRID_FR(1), LV_GRID_FR(1), LV_GRID_TEMPLATE_LAST}; lv_obj_set_grid_dsc_array(grid_container, col_dsc,row_dsc); lv_obj_t *o2_card=lv_obj_create(grid_container); lv_obj_set_grid_cell(o2_card, LV_GRID_ALIGN_STRETCH,0,1, LV_GRID_ALIGN_STRETCH,0,1); lv_obj_set_style_bg_color(o2_card, COLOR_SECONDARY,0); lv_obj_set_style_border_width(o2_card,2,0); lv_obj_set_style_border_color(o2_card, lv_color_white(),0); lv_obj_set_style_radius(o2_card,10,0); lv_obj_t *o2_title=lv_label_create(o2_card); lv_label_set_text(o2_title,"Oxygen"); lv_obj_set_style_text_color(o2_title, lv_color_white(),0); lv_obj_set_style_text_font(o2_title, &custom_font_normal_20, 0); lv_obj_align(o2_title, LV_ALIGN_TOP_MID,0,5); lv_obj_t *label_o2=lv_label_create(o2_card); lv_label_set_text(label_o2,"20.9 %"); lv_obj_set_style_text_color(label_o2, lv_color_white(),0); lv_obj_set_style_text_font(label_o2,&custom_font_bold_24,0); lv_obj_align(label_o2, LV_ALIGN_CENTER,0,5); mgr.set_label_o2(label_o2); lv_obj_t *co2_card=lv_obj_create(grid_container); lv_obj_set_grid_cell(co2_card, LV_GRID_ALIGN_STRETCH,1,1, LV_GRID_ALIGN_STRETCH,0,1); lv_obj_set_style_bg_color(co2_card, COLOR_WARNING,0); lv_obj_set_style_border_width(co2_card,2,0); lv_obj_set_style_border_color(co2_card, lv_color_white(),0); lv_obj_set_style_radius(co2_card,10,0); lv_obj_t *co2_title=lv_label_create(co2_card); lv_label_set_text(co2_title,"CO2"); lv_obj_set_style_text_color(co2_title, lv_color_white(),0); lv_obj_set_style_text_font(co2_title, &custom_font_normal_20, 0); lv_obj_align(co2_title, LV_ALIGN_TOP_MID,0,5); lv_obj_t *label_co2=lv_label_create(co2_card); lv_label_set_text(label_co2,"400 ppm"); lv_obj_set_style_text_color(label_co2, lv_color_white(),0); lv_obj_set_style_text_font(label_co2,&custom_font_bold_24,0); lv_obj_align(label_co2, LV_ALIGN_CENTER,0,5); mgr.set_label_co2(label_co2); lv_obj_t *temp_card=lv_obj_create(grid_container); lv_obj_set_grid_cell(temp_card, LV_GRID_ALIGN_STRETCH,0,1, LV_GRID_ALIGN_STRETCH,1,1); lv_obj_set_style_bg_color(temp_card, COLOR_PRIMARY,0); lv_obj_set_style_border_width(temp_card,2,0); lv_obj_set_style_border_color(temp_card, lv_color_white(),0); lv_obj_set_style_radius(temp_card,10,0); lv_obj_t *temp_title=lv_label_create(temp_card); lv_label_set_text(temp_title,"Temperature"); lv_obj_set_style_text_color(temp_title, lv_color_white(),0); lv_obj_set_style_text_font(temp_title, &custom_font_normal_20, 0); lv_obj_align(temp_title, LV_ALIGN_TOP_MID,0,5); lv_obj_t *label_temp=lv_label_create(temp_card); lv_label_set_text(label_temp,"22.5 °C"); lv_obj_set_style_text_color(label_temp, lv_color_white(),0); lv_obj_set_style_text_font(label_temp,&custom_font_bold_24,0); lv_obj_align(label_temp, LV_ALIGN_CENTER,0,5); mgr.set_label_temp(label_temp); lv_obj_t *press_card=lv_obj_create(grid_container); lv_obj_set_grid_cell(press_card, LV_GRID_ALIGN_STRETCH,1,1, LV_GRID_ALIGN_STRETCH,1,1); lv_obj_set_style_bg_color(press_card, COLOR_PRIMARY,0); lv_obj_set_style_border_width(press_card,2,0); lv_obj_set_style_border_color(press_card, lv_color_white(),0); lv_obj_set_style_radius(press_card,10,0); lv_obj_t *press_title=lv_label_create(press_card); lv_label_set_text(press_title,"Pressure"); lv_obj_set_style_text_color(press_title, lv_color_white(),0); lv_obj_set_style_text_font(press_title, &custom_font_normal_20, 0); lv_obj_align(press_title, LV_ALIGN_TOP_MID,0,5); lv_obj_t *label_pressure=lv_label_create(press_card); lv_label_set_text(label_pressure,"1.01 bar"); lv_obj_set_style_text_color(label_pressure, lv_color_white(),0); lv_obj_set_style_text_font(label_pressure,&custom_font_bold_24,0); lv_obj_align(label_pressure, LV_ALIGN_CENTER,0,5); mgr.set_label_pressure(label_pressure); lv_obj_t *hum_card=lv_obj_create(grid_container); lv_obj_set_grid_cell(hum_card, LV_GRID_ALIGN_STRETCH,0,2, LV_GRID_ALIGN_STRETCH,2,1); lv_obj_set_style_bg_color(hum_card, COLOR_PRIMARY,0); lv_obj_set_style_border_width(hum_card,2,0); lv_obj_set_style_border_color(hum_card, lv_color_white(),0); lv_obj_set_style_radius(hum_card,10,0); lv_obj_t *hum_title=lv_label_create(hum_card); lv_label_set_text(hum_title,"Humidity"); lv_obj_set_style_text_color(hum_title, lv_color_white(),0); lv_obj_set_style_text_font(hum_title, &custom_font_normal_20, 0); lv_obj_align(hum_title, LV_ALIGN_TOP_MID,0,5); lv_obj_t *label_humidity=lv_label_create(hum_card); lv_label_set_text(label_humidity,"45.2 %"); lv_obj_set_style_text_color(label_humidity, lv_color_white(),0); lv_obj_set_style_text_font(label_humidity,&custom_font_bold_24,0); lv_obj_align(label_humidity, LV_ALIGN_CENTER,0,5); mgr.set_label_humidity(label_humidity); create_navbar(screen); return screen; }

static lv_obj_t *create_settings_screen(void){ lv_obj_t *screen=lv_obj_create(NULL); lv_obj_set_style_bg_color(screen, COLOR_BACKGROUND,0); lv_obj_t *title=lv_label_create(screen); lv_label_set_text(title,"Settings"); lv_obj_set_style_text_font(title,&custom_font_bold_24,0); lv_obj_set_style_text_color(title, lv_color_white(),0); lv_obj_align(title, LV_ALIGN_TOP_MID,0,10); lv_obj_t *menu_container=lv_obj_create(screen); lv_obj_set_size(menu_container, LV_PCT(85),450); lv_obj_center(menu_container); lv_obj_set_style_bg_opa(menu_container, LV_OPA_TRANSP,0); lv_obj_set_style_border_width(menu_container,0,0); lv_obj_set_flex_flow(menu_container, LV_FLEX_FLOW_COLUMN); lv_obj_set_style_pad_gap(menu_container,20,0); lv_obj_t *btn_calibrate=lv_btn_create(menu_container); lv_obj_set_size(btn_calibrate, LV_PCT(100),60); lv_obj_set_style_bg_color(btn_calibrate, COLOR_SECONDARY,0); lv_obj_add_event_cb(btn_calibrate,event_go_calibrate_o2, LV_EVENT_CLICKED,nullptr); lv_obj_t *calibrate_label=lv_label_create(btn_calibrate); lv_label_set_text(calibrate_label,"O2 Sensor Calibration"); lv_obj_set_style_text_font(calibrate_label,&custom_font_normal_20,0); lv_obj_center(calibrate_label); lv_obj_t *btn_sysinfo=lv_btn_create(menu_container); lv_obj_set_size(btn_sysinfo, LV_PCT(100),60); lv_obj_set_style_bg_color(btn_sysinfo, COLOR_PRIMARY,0); lv_obj_t *sysinfo_label=lv_label_create(btn_sysinfo); lv_label_set_text(sysinfo_label,"System Information"); lv_obj_set_style_text_font(sysinfo_label,&custom_font_normal_20,0); lv_obj_center(sysinfo_label); lv_obj_t *btn_about=lv_btn_create(menu_container); lv_obj_set_size(btn_about, LV_PCT(100),60); lv_obj_set_style_bg_color(btn_about, COLOR_PRIMARY,0); lv_obj_t *about_label=lv_label_create(btn_about); lv_label_set_text(about_label,"About"); lv_obj_set_style_text_font(about_label,&custom_font_normal_20,0); lv_obj_center(about_label); create_navbar(screen); return screen; }

static lv_obj_t *create_calibrate_o2_screen(void){ lv_obj_t *screen=lv_obj_create(NULL); lv_obj_set_style_bg_color(screen, COLOR_BACKGROUND,0); lv_obj_t *title=lv_label_create(screen); lv_label_set_text(title,"O2 Calibration"); lv_obj_set_style_text_font(title,&custom_font_bold_24,0); lv_obj_set_style_text_color(title, lv_color_white(),0); lv_obj_align(title, LV_ALIGN_TOP_MID,0,10); lv_obj_t *instructions=lv_label_create(screen); lv_label_set_text(instructions,"1. Ensure sensor is exposed to normal air\n2. Wait for readings to stabilize\n3. Press 'Calibrate' to set 20.9% O2"); lv_obj_set_style_text_color(instructions, lv_color_white(),0); lv_obj_set_style_text_font(instructions, &custom_font_normal_16, 0); lv_obj_set_style_text_align(instructions, LV_TEXT_ALIGN_CENTER,0); lv_obj_align(instructions, LV_ALIGN_CENTER,0,-60); lv_obj_t *current_reading=lv_label_create(screen); lv_label_set_text(current_reading,"Current: 20.9% O2"); lv_obj_set_style_text_font(current_reading,&custom_font_bold_20,0); lv_obj_set_style_text_color(current_reading, COLOR_SECONDARY,0); lv_obj_align(current_reading, LV_ALIGN_CENTER,0,0); lv_obj_t *btn_calibrate=lv_btn_create(screen); lv_obj_set_size(btn_calibrate,200,60); lv_obj_align(btn_calibrate, LV_ALIGN_CENTER,0,60); lv_obj_set_style_bg_color(btn_calibrate, COLOR_SECONDARY,0); lv_obj_add_event_cb(btn_calibrate,event_do_o2_calibration, LV_EVENT_CLICKED,nullptr); lv_obj_t *calibrate_label=lv_label_create(btn_calibrate); lv_label_set_text(calibrate_label,"Calibrate Now"); lv_obj_set_style_text_font(calibrate_label,&custom_font_normal_20,0); lv_obj_center(calibrate_label); lv_obj_t *btn_back=lv_btn_create(screen); lv_obj_set_size(btn_back,100,40); lv_obj_align(btn_back, LV_ALIGN_BOTTOM_LEFT,10,-10); lv_obj_set_style_bg_color(btn_back, COLOR_PRIMARY,0); lv_obj_add_event_cb(btn_back,event_back_to_settings, LV_EVENT_CLICKED,nullptr); lv_obj_t *back_label=lv_label_create(btn_back); lv_label_set_text(back_label,"Back"); lv_obj_center(back_label); return screen; }
